...
public class ImageService {
     ...
     * @throws IOException
     */
    public void saveAdditionalImages(CommonsMultipartFile file, BaseImagesSupport base) throws IOException {
        String pathToImagesFolder = checkPathToImagesFolder(base);

        if (file.getSize() != 0) {
            saveToDiskScaled(file, pathToImagesFolder, "", IMAGE_MAX_WIDTH, -1);
            saveToDiskScaled(file, pathToImagesFolder, SMALL_IMAGE_PREFIX, -1, SMALL_IMAGE_HEIGHT);
     ...
     * @throws java.io.IOException
     */
    public void saveAdditionalImages(List<CommonsMultipartFile> files, BaseImagesSupport base) throws IOException {
        String pathToImagesFolder = checkPathToImagesFolder(base);
    ...
    private String correctFolderSeparator(String yearMonthUniqueFolder) {
        ...
        String[] splittedByFolderSeparator = yearMonthUniqueFolder.split(SPLIT_BY);
    ...
    public String getPathToLargeImage(ImageImpl img, BaseImagesSupport base) {
        ...
        return sb.append(IMAGE_URL_PREFIX)
                .append(joinedYearMonthUniqueFolder)
                .append(SLASH)
                .append(img.getOriginalImageName())
                .toString();
    }
    ...
    private String checkPathToImagesFolder(BaseImagesSupport base) {
        ...
        if (base.getYearMonthUniqueFolder() == null) {
            ...
            sb.append(getImagesFolderAbsolutePath())
    ...
    private void saveToDiskScaled(CommonsMultipartFile file, String pathToImagesFolder, String outputFilePrefix,
        ...
        sb = new StringBuilder();
        sb.append(pathToImagesFolder)
                .append(FOLDER_SEPARATOR)
                .append(outputFilePrefix)
