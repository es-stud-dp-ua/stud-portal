                                ...
                                <div style="float: right; margin-top: 30px; ">
                                    <table >
                                        ...
                                        <tr >
                                            ...
                                            <td ><input type="radio" name="type" value="<%= OrganizationType.SPORTS %>" checked="" style="float: right;"/></td>
                                        </tr>
                                        <tr>
                                            <td><div style="float: right; margin-right: 10px; "><spring:message code="form.YOUNGSTERS"/></div></td>
                                            <td> <input type="radio" name="type" value="<%= OrganizationType.YOUNGSTERS %>" style="float: right;"/></td>
                                        </tr>
                                        <tr>
                                            <td><div style="float: right; margin-right: 10px;"><spring:message code="form.VOLUNTEERING"/></div></td>
                                            <td> <input type="radio" name="type" value="<%= OrganizationType.VOLUNTEERING %>" style="float: right;"/></td>
                                        </tr>
                                        <tr>
                                            <td><div style="float: right; margin-right: 10px;"><spring:message code="form.CHARITY"/></div></td>
                                            <td> <input type="radio" name="type" value="<%= OrganizationType.CHARITY %>" style="float: right;"/></td>
                                        </tr>
                                        <tr>
                                            <td><div style="float: right; margin-right: 10px;"><spring:message code="form.INT_ORGS"/></div></td>
                                            <td> <input type="radio" name="type" value="<%= OrganizationType.INT_ORGS %>" style="float: right;"/></td>
                                        </tr>
                                        <tr>
                                            <td><div style="float: right; margin-right: 10px;"><spring:message code="form.ART"/></div></td>
                                            <td> <input type="radio" name="type" value="<%= OrganizationType.ART %>" style="float: right;"/></td>
                                        </tr>
                                        <tr>
                                            <td><div style="float: right; margin-right: 10px;"><spring:message code="form.OTHERS"/></div></td>
                                            <td> <input type="radio" name="type" value="<%= OrganizationType.OTHERS %>" style="float: right;"/></td>
                                        </tr>
                                    </table>
                                </div>
