                ...
                <td width="50%" align="center">
                    ...
                    <div style="margin-top: 420px;">
                        <div id="facultetD" style="float: left;">
                            ...
                            <textarea id="facultetInput" cols="60" rows="1" maxlength="90"
                                      onkeyup="isNotMax(event, getAttribute('id'))" name="facultetDnevn"
                                      style="float: left; margin-top: 15px;"></textarea>
                        ...
                        <div style="float: left;">
                            ...
                            <textarea id="adressInput" cols="60" rows="1" maxlength="90"
                                      onkeyup="isNotMax(event, getAttribute('id'))" name="adress"
                                      style="float: left; margin-top: 15px;"></textarea><br/><br/>
                        </div>
                    </div>
                </td>
                <td rowspan=2 width="50%" align="left" style="vertical-align: top ">
                    ...
                    <div style="width: 450px; float: bottom ; padding-left: 8px;">
                        <textarea class="ckeditor" id="textInput" cols="60" rows="10" maxlength="8000"
                                  onkeyup="isNotMax(event, getAttribute('id'))" name="text"
                                  placeholder="<spring:message code="form.text"/>"></textarea><br/><br/>
                    </div>
                    <br/>

                    <div id="facultetZ" style="float: left;">
                        <label style="font-size:16px; font-weight: bold;"><spring:message code="form.zaoch"/></label>
                        <br/>
                        <textarea id="facultetInput" cols="60" rows="1" maxlength="90"
                                  onkeyup="isNotMax(event, getAttribute('id'))" name="facultetZaoch"
                                  style="float: left; margin-top: 15px;"></textarea>
                        <input type="button" id="plus1" name="plus1" value="+" onclick="Add2()"
                               style="float: right; margin-top: 18px; margin-left: 3px; "/>
                    </div>
                    <br/> <br/>
