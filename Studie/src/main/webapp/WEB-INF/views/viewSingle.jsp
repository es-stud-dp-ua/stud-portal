...
<body>
  ...
  <br/> <br/>
	<ul style="margin-left:-11px; margin-right: 20px" align="left" >
		...
		<div class="singleGelery" id="inner">
			<%for(ImageImpl image:additionalImages){
				...
				<div class="ownGelery" style="margin-left: 5px;">
					<a class="fancybox-thumbs" data-fancybox-group="thumb" href="<%=imageService.getPathToLargeImage(image, studie) %>" <% if (request.isUserInRole("Administrator")) { %>title='<a href="<portlet:renderURL/>&imageId=<%=image.getId()%>&mode=delImage" onclick="return ConfirmImage()"> <spring:message code="form.delete"/></a>'<%}%>>
...
<div id="underline-decoration" align="center">
    <table>
        <tr>
            ...
            <label   onclick="showHide('spisok','plusik');" style="font-size:16px; font-weight: bold; "><spring:message code="form.dnevnforma"/></label>
...
<div id="spisok" style="display:none">
 <ul>    	
	 <%  
        ...
        <br/>
	 <label  onclick="showHide('spisok2','plusik2');" style="font-size:16px; font-weight: bold; " ><spring:message code="form.zaochforma"/></label> 
