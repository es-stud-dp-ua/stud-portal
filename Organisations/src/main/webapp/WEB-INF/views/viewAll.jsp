    ...
    <div id="contentDiv">
        ...
        <div id="newsTable">
            ...
            <div width="100%">
                ...
                <a style="float: right" href='<portlet:renderURL><portlet:param name="orgId" value="<%=currentOrgs.getId().toString()%>"/><portlet:param name="currentPage" value="<%=currentPage.toString()%>"/><portlet:param name="mode" value="delete" /></portlet:renderURL>'
                   onclick='return confirm("<spring:message code="form.confDelete"/>")'>
                    <div class="panelbtn panelbtn-right fs20 icon-pcpremove" aria-hidden="true"></div>
                </a>
                <a style="float: right" href='<portlet:renderURL><portlet:param name="orgId" value="<%=currentOrgs.getId().toString()%>"/><portlet:param name="mode" value="edit" /></portlet:renderURL>'>
